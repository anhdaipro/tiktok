            ...
            <div className="tiktok-vwwmft-Usercotainer e2ipgxl0">
                ...
                <ul className="tiktok-list-item">
                    ...
                    <li onClick={()=>navigate(`/search?query=${item.tile}`)} className="tiktok-item">
                        ...
                        <span class="tiktok-username">{item.title}</span>
                    </li>)}
                </ul>
                <div className="tiktok-list-item">
                    {listusser.map(item=>
                    <div  onClick={()=>navigate(`/${item.username}`)} class="jsx-1498925541 container">
                        <img src={item.picture} class="jsx-1498925541 avatar"/>
                        <div class="jsx-1498925541 user-info">
                            <div class="jsx-1498925541 name">{item.name}</div>
                            <div class="jsx-1498925541 user-id">@{item.username}</div>
                        </div>
                    </div>)}
                </div>
                </div>
            ...
            <div className="tiktok-notu47-DivHeaderWrapperMain e10win0d1">
                ...
                <div className="tiktok-ba55d9-DivHeaderRightContainer e13wiwn60">
                    ...
                    <div onMouseEnter={()=>setState({...state,show_upload:true})} onMouseLeave={()=>setState({...state,show_upload:false})} data-e2e="upload-icon" className="tiktok-1r4w1e7-DivUploadContainer e18d3d940">
                        ...
                        {state.show_upload?
                        <div class="tiktok-tooltip black withPadding tiktok-tooltip-placement-bottom  tiktok-tooltip-hidden" style={{right: '-15px', top: '40px'}}>
                            <div class="tiktok-tooltip-content">
                                <div class="tiktok-tooltip-arrow"></div>
                                <div class="tiktok-tooltip-inner" role="tooltip">Upload video</div>
                            </div>
                        </div>:''}
                    </div>
                    <div onMouseEnter={()=>setState({...state,show_message:true})} onMouseLeave={()=>setState({...state,show_message:false})} data-e2e="top-dm-icon" className="tiktok-1ibfxbr-DivMessageIconContainer e1nx07zo0">
                        ...
                        <div class="tiktok-tooltip black withPadding tiktok-tooltip-placement-bottom  tiktok-tooltip-hidden" style={{right: '-15px', top: '40px'}}>
                            <div class="tiktok-tooltip-content">
                                <div class="tiktok-tooltip-arrow"></div>
                                <div class="tiktok-tooltip-inner" role="tooltip">Message</div>
                            </div>
                        </div>:''}
                    </div>
                    ...
                    <div ref={notifyref} data-e2e="inbox-icon" className="tiktok-1b4xcc5-DivHeaderInboxContainer e18kkhh40">
                        ...
                        {notify.count_notify_unseen>0 && notify.send_to==user.id?<sup class="jsx-3087598692 ">{notify.count_notify_unseen}</sup>:''}
                        ...
                        {state.show_inbox?
                        <div class="tiktok-tooltip black withPadding tiktok-tooltip-placement-bottom  tiktok-tooltip-hidden" style={{right: '-50%', top: '40px'}}>
                            <div class="tiktok-tooltip-content">
                                <div class="tiktok-tooltip-arrow"></div>
                                <div class="tiktok-tooltip-inner" role="tooltip">Inbox</div>
                            </div>
                        </div>:''}
