                    ...
                    <div className="e14l9ebt0 tiktok-1cx1pch-DivScrollContainer-StyledScroll e1b4u1n1">
                        <div className="tiktok-1a4urrd-DivWrapper e14l9ebt2">
                            <div className="tiktok-1inll25-DivMainNavContainer e14l9ebt8">
                                ...
                                <div>
                                    <NavLink data-e2e="nav-following" onClick={setshowfollowing} style={{border:'none'}} className="tiktok-chxswy-StyledTmpLink e14l9ebt5" to="/following">
                                        {({isActive}) =>(
                                            <>
                                ...
                                <div>
                                    <NavLink to="/" data-e2e="nav-live" style={{border:'none'}} className="tiktok-chxswy-StyledTmpLink e14l9ebt5">
                                        {({isActive})=>(
                                            <>
