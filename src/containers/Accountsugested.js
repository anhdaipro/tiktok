...
const Sinabar=(props)=>{
    ...
    return(
        <div class="tiktok-r0hg2a-DivSideNavContainer eg65pf91">
            <div>
                <div class="tiktok-ixclwa-DivSideNavMask eg65pf92"></div>
                <div class="tiktok-1ebkqxa-DivSideNavContainer e14l9ebt1">   
                    <div class="e14l9ebt0 tiktok-1cx1pch-DivScrollContainer-StyledScroll e1b4u1n1">
                        <div class="tiktok-1a4urrd-DivWrapper e14l9ebt2">
                            <div class="tiktok-1inll25-DivMainNavContainer e14l9ebt8">
                                <div>
                                    <a data-e2e="nav-foryou" class="tiktok-chxswy-StyledTmpLink e14l9ebt5" href="/en">
                            ...
                            <div class="tiktok-1liq5tk-DivUserContainer e4a681b0">
                                ...
                                <div onMouseEnter={(e)=>setuser(e,index,'show_info',true)} onMouseLeave={(e)=>setuser(e,index,'show_info',false)} key={index} class="tiktok-kwqs83-DivUserLinkContainer e797se20">
                                    ...
                                    <Link class="tiktok-1g0yu4c-StyledUserContentLink e797se24" to={`/${item.user.username}`}>
                                        <div class="tiktok-yt7cul-DivUserTitleWrapper e797se26">
                                            <h4 data-e2e="suggest-user-title" class="tiktok-arsb3q-H4UserTitle e797se27">{item.user.username}</h4>
                                        ...
                                        <p data-e2e="suggest-user-desc" class="tiktok-1f4lmy9-PUserDesc e797se29">{item.user.name}</p>
                                    </Link>
                                </div>)}}
                                )}
                                {state.show_all_suggested || list_sugessted.length<5?'':
                                <div onClick={(e)=>addusersuggest(e)} data-e2e="see-all" class="tiktok-1n9adg1-DivShowMoreTextContainer e4a681b2">
                                    <p data-e2e="suggest-see-all" class="tiktok-1ezua2b-PShowMoreText e4a681b3">See all</p>
                                </div>}
                            </div>
                            {user!=null?
                            <div class="tiktok-1liq5tk-DivUserContainer e4a681b0">
                                <p data-e2e="suggest-accounts" class="tiktok-kkg08c-PTitle e4a681b1">Các tài khoản đang follow</p>
                                {listuser.map((item,index)=>{
                                    if(!item.suggested){
                                    return(
                                    <div onMouseEnter={(e)=>setuser(e,index,'show_info',true)} onMouseLeave={(e)=>setuser(e,index,'show_info',false)} key={index} class="tiktok-kwqs83-DivUserLinkContainer e797se20"> 
                                        ...
                                        <Link class="tiktok-1g0yu4c-StyledUserContentLink e797se24" to={`/${item.user.username}`}>
                                            <div class="tiktok-yt7cul-DivUserTitleWrapper e797se26">
                                                <h4 data-e2e="following-user-title" class="tiktok-arsb3q-H4UserTitle e797se27">{item.user.username}</h4>
                                            </div>
                                            <p data-e2e="following-user-desc" class="tiktok-1f4lmy9-PUserDesc e797se29">{item.user.name}</p>
                                        </Link>
                                    </div>
                                )}})}
                                {state.show_all_following || list_followers.length<5?'':
                                <div data-e2e="see-all" class="tiktok-1n9adg1-DivShowMoreTextContainer e4a681b2">
                                    <p onClick={(e)=>adduserfollowing(e)} data-e2e="following-see-all" class="tiktok-1ezua2b-PShowMoreText e4a681b3">See all</p>
                                </div>}
                            </div>
                            :''}
                            <div class="tiktok-5gba95-DivDiscoverContainer eikhr9j2">
                                <p data-e2e="nav-discover-title" class="tiktok-m6qd4i-PDiscoverTitle eikhr9j3">Discover</p>
                                <div class="tiktok-1ca819s-DivDiscoverListContainer eikhr9j4">
                                    {listhagtag.map(item=>
                                    <Link data-e2e="nav-discover-href" class="tiktok-1rw2y63-StyledTmpLink eikhr9j6" key={item.id} to={`/tag/${item.name.replace('#','')}?lang=en`}>
                                        <div class="tiktok-1qlwqct-DivDiscoverItemContainer eikhr9j7">
                                            <svg class="tiktok-1hy6k9f-StyledNumber eikhr9j9" width="16" height="16" viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M16.4263 15L16.9566 3.95205C16.9822 3.41902 17.4218 2.99999 17.9554 2.99999H19.9494C20.5202 2.99999 20.9752 3.47701 20.9483 4.04718L20.4308 15H28.4263L28.9566 3.95205C28.9822 3.41902 29.4218 2.99999 29.9554 2.99999H31.9494C32.5202 2.99999 32.9752 3.47701 32.9483 4.04718L32.4308 15H43C43.5523 15 44 15.4477 44 16V18C44 18.5523 43.5523 19 43 19H32.2404L31.8118 28H42C42.5523 28 43 28.4477 43 29V31C43 31.5523 42.5523 32 42 32H31.6213L31.0434 44.0479C31.0178 44.581 30.5782 45 30.0446 45H28.0507C27.4798 45 27.0248 44.523 27.0518 43.9528L27.6168 32H19.6213L19.0434 44.0479C19.0178 44.581 18.5782 45 18.0446 45H16.0507C15.4798 45 15.0248 44.523 15.0518 43.9528L15.6168 32H5C4.44772 32 4 31.5523 4 31V29C4 28.4477 4.44772 28 5 28H15.8073L16.2358 19H6C5.44772 19 5 18.5523 5 18V16C5 15.4477 5.44772 15 6 15H16.4263ZM20.2404 19L19.8118 28H27.8073L28.2358 19H20.2404Z"></path></svg>
                                            <p class="tiktok-1sw5kok-PText eikhr9j12">{item.name.replace('#','')}</p>
                                        </div>
                                    </Link>)}
                                </div>
                            </div>
                            <div class="tiktok-1clhv1s-DivPlaceholder e14l9ebt6"></div>
                            <div class="tiktok-1oisxeb-DivFooterContainer el3hfgg0">
                                <div class="tiktok-1lepjzi-DivLinkContainer el3hfgg1">
                                    <a href="https://www.tiktok.com/about?lang=en" data-e2e="page-link" target="_blank" class="tiktok-4fb5qk-StyledNavLink el3hfgg3">About</a>
                                    <a href="https://newsroom.tiktok.com/" data-e2e="page-link" target="_blank" class="tiktok-4fb5qk-StyledNavLink el3hfgg3">Newsroom</a>
                                    <a href="https://www.tiktok.com/about/contact?lang=en" data-e2e="page-link" target="_blank" class="tiktok-4fb5qk-StyledNavLink el3hfgg3">Contact</a>
                                    <a href="https://careers.tiktok.com" data-e2e="page-link" target="_blank" class="tiktok-4fb5qk-StyledNavLink el3hfgg3">Careers</a>
                                    <a href="https://www.bytedance.com/" data-e2e="page-link" target="_blank" class="tiktok-4fb5qk-StyledNavLink el3hfgg3">ByteDance</a>
                                </div>
                                <div class="tiktok-1lepjzi-DivLinkContainer el3hfgg1">
                                    <a href="https://www.tiktok.com/forgood" data-e2e="program-link" target="_blank" class="tiktok-4fb5qk-StyledNavLink el3hfgg3">TikTok for Good</a>
                                    <a href="https://www.tiktok.com/business/?attr_medium=tt_official_site_guidance&amp;attr_source=tt_official_site&amp;refer=tiktok_web" data-e2e="program-link" target="_blank" class="tiktok-4fb5qk-StyledNavLink el3hfgg3">Advertise</a>
                                    <a href="https://developers.tiktok.com/?refer=tiktok_web" data-e2e="program-link" target="_blank" class="tiktok-4fb5qk-StyledNavLink el3hfgg3">Developers</a><a href="https://www.tiktok.com/transparency?lang=en" data-e2e="program-link" target="_blank" class="tiktok-4fb5qk-StyledNavLink el3hfgg3">Transparency</a>
                                    <a href="https://www.tiktok.com/tiktok-rewards/en" data-e2e="program-link" target="_blank" class="tiktok-4fb5qk-StyledNavLink el3hfgg3">TikTok Rewards</a></div><div class="tiktok-1lepjzi-DivLinkContainer el3hfgg1"><a href="https://support.tiktok.com/en" data-e2e="legal-link" target="_blank" class="tiktok-4fb5qk-StyledNavLink el3hfgg3">Help</a>
                                    <a href="https://www.tiktok.com/safety?lang=en" data-e2e="legal-link" target="_blank" class="tiktok-4fb5qk-StyledNavLink el3hfgg3">Safety</a>
                                    <a href="https://www.tiktok.com/legal/terms-of-service?lang=en" data-e2e="legal-link" target="_blank" class="tiktok-4fb5qk-StyledNavLink el3hfgg3">Terms</a>
                                    <a href="https://www.tiktok.com/legal/privacy-policy-row?lang=en" data-e2e="legal-link" target="_blank" class="tiktok-4fb5qk-StyledNavLink el3hfgg3">Privacy</a>
                                    <a href="https://www.tiktok.com/creators/creator-portal/en-us/" data-e2e="legal-link" target="_blank" class="tiktok-4fb5qk-StyledNavLink el3hfgg3">Creator Portal</a>
                                    <a href="https://www.tiktok.com/community-guidelines?lang=en" data-e2e="legal-link" target="_blank" class="tiktok-4fb5qk-StyledNavLink el3hfgg3">Community Guidelines</a>
                                </div>
                                <span data-e2e="copyright" class="tiktok-ztf279-SpanCopyright el3hfgg2">© 2022 TikTok</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {listuser.some(item=>item.show_info)?
                    <div  onMouseLeave={(e)=>setkeepuser(e,state.index,'show_info',false)} onMouseEnter={(e)=>setkeepuser(e,state.index,'show_info',true)} style={{left:`${state.left}px`,top:`${state.top}px`}}  class="tiktok-xhmvja-DivProfileOuterContainer er095111">
                        ...
                        <div class="tiktok-vnenbs-DivProfileContainer er095112">
                            <div class="tiktok-1tu3lcg-DivHeadContainer er095113">
                                <a target="_blank" rel="noopener" data-e2e="user-card-avatar" class="tiktok-h0b8t7-StyledAvatarLink er095116" href={`/${user_choice.user.username}?lang=en`}>
                                    <span shape="circle" class="tiktok-tuohvl-SpanAvatarContainer e1e9er4e0" style={{width: '44px', height: '44px'}}>
                                        <img loading="lazy" src={user_choice.user.picture} class="tiktok-1zpj2q-ImgAvatar e1e9er4e1"/>
                                    </span>
                                </a>
                                <button onClick={(e)=>setfollowuser(e,user_choice)} type="button" data-e2e="user-card-follow" class="tiktok-230my5-Button ehk74z00">{user_choice.following?'Following':'Follow'}</button>
                            </div>
                            <a target="_blank" rel="noopener" class="tiktok-gk82i-StyledUserTitle er095114" href={`/${user_choice.user.username}?lang=en`}>
                                <span data-e2e="user-card-username">{user_choice.user.username}</span>
                            </a><br/>
                            <a target="_blank" rel="noopener" data-e2e="user-card-nickname" class="tiktok-px0n0u-StyledUserName er095115" href={`/${user_choice.user.username}?lang=en`}>{user_choice.user.name} 👑</a>
                            <p class="tiktok-1gj7x9t-PUserStat er095117">
                                <span data-e2e="user-card-follower-count" class="tiktok-ceyvsn-SpanUserStatsText er095118">{number(user_choice.count_followers)}</span>
                                <span data-e2e="user-card-follower" class="tiktok-1n85168-SpanUserStatsDesc er095119">Followers</span>
                                <span data-e2e="user-card-like-count" class="tiktok-ceyvsn-SpanUserStatsText er095118">{number(user_choice.count_likers)}</span>
