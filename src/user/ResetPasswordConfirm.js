...
const ResetPasswordConfirm = ({ match, reset_password_confirm }) => {
    ...
    const [state,setState]=useState({showpass:false,showrepass:false})
                ...
                <div className="_1ilxso">
                    <div className="_1wjIrC">
                        <a className="_33_X2D" href="/">
                         ...
                         <div className="_2oP3Vy">Đặt lại mật khẩu</div>
                     </div>
                     ...
                     <form onSubmit={e=>onSubmit(e)}>
                        <div className="_15Lr4G _34gSQ-">
                            ...
                            <div className="_3e4zDA _2kpMlA">
                                ...
                                <button className="_1ruZ5a _3Nrkgj _3kANJY _1IRuK_ _1yQY41 hh2rFL _3_offS" disabled={validatePassword(formData.password).length>0?true:false}>Tiếp tục</button>
                            </div>
                        </div>
                    </form>
                </div> 
